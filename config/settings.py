...
APPS_DIR = BASE_DIR / "vector_search"
...
LOCAL_APPS = ["vector_search.core", "vector_search.users"]
...
DATABASES = {"default": env.db("DATABASE_URL", default="postgres:///vector_search")}
...
ACCOUNT_FORMS = {"signup": "vector_search.users.forms.UserSignupForm"}
